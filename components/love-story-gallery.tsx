  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      style={(src === '/love-story1.jpg' || src === '/love-story2.jpg') ? { objectPosition: 'center top' } : undefined}
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      fill
                      className="object-cover"
                      style={src === '/love-story3.jpg' ? { objectPosition: 'center top' } : undefined}
                      sizes="(max-width: 640px) 208px, (max-width: 768px) 240px, (max-width: 1024px) 288px, 320px"
                    />
        ...
        >
          <p className="font-luxury text-2xl sm:text-3xl md:text-4xl text-foreground italic leading-relaxed">
            The sea knew before we did. 🌊🤍
          </p>
        </motion.div>
      </div>
    </section>
