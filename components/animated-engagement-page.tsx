              ...
              >
                <div className="bg-card/80 backdrop-blur-sm border border-accent/20 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      <motion.h3
                        className="text-4xl md:text-5xl font-serif text-accent mb-2"
                      >
                        Havana Hall
                      </motion.h3>
                      <motion.p
                    ...
                    >
                      <div className="flex items-center gap-4 text-lg">
                        ...
                        <span className="text-xl font-medium text-foreground">January 29, 2026</span>
                      </div>
