    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-16 px-4 md:py-24 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <CountdownTimer targetDate={new Date("2026-01-29T19:00:00")} />
        </div>
      </section>
          ...
          <div className="text-center space-y-6 mb-16">
            ...
            <div className="max-w-2xl mx-auto space-y-6 mt-8">
              <div className="bg-card/50 backdrop-blur-sm border border-accent/20 rounded-2xl p-8 md:p-10 shadow-xl">
                <div className="mb-3">
                  <p className="text-3xl md:text-4xl font-serif text-accent">Havana Hall</p>
                  <p className="text-xl md:text-2xl font-serif text-muted-foreground mt-1">Al-Sharqia</p>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-6 border-t border-accent/10">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-lg text-foreground">January 29, 2026</span>
                  </div>
