...
export default function VenueMap() {
  ...
  // Google Maps URL for Havana Hall Al-Sharqia
  const googleMapsUrl = "https://maps.app.goo.gl/AShSuQR9AiUiMz9W9?g_st=ic"
          ...
          <div className="mt-6 text-center px-4">
            <div className="mb-2">
              <h3 className="text-xl sm:text-2xl font-serif font-medium text-foreground">
                {isRTL ? 'هافانا' : 'Havana Hall'}
            </h3>
              <p className="text-base sm:text-lg font-serif text-muted-foreground mt-1">
                {isRTL ? 'الشرقية' : 'Al-Sharqia'}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>{isRTL ? 'الشرقية' : 'Al-Sharqia'}</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
